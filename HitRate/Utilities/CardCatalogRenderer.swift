    ...
    private static var milestones: [(slug: String, m: Milestone)] {
        [
            ("ms-reps10-first-ten", Milestone(
                id: "reps10", kind: .stunt, variantIndex: 0, kicker: "MILESTONE", name: "First Ten",
            ...
            ("ms-reps100-century-club", Milestone(
                id: "reps100", kind: .stunt, variantIndex: 0, kicker: "MILESTONE", name: "Century Club",
            ...
            ("ms-reps500-grinder", Milestone(
                id: "reps500", kind: .stunt, variantIndex: 0, kicker: "MILESTONE", name: "Grinder",
            ...
            ("ms-reps1000-four-digits", Milestone(
                id: "reps1000", kind: .stunt, variantIndex: 0, kicker: "MILESTONE", name: "Four Digits",
            ...
            ("ms-streak5-high-five", Milestone(
                id: "streak5", kind: .stunt, variantIndex: 0, kicker: "MILESTONE", name: "High Five",
            ...
            ("ms-streak10-hot-hand-coach", Milestone(
                id: "streak10", kind: .stunt, variantIndex: 0, kicker: "MILESTONE", name: "Hot Hand",
            ...
            ("ms-streak25-untouchable-alt", Milestone(
                id: "streak25", kind: .stunt, variantIndex: 0, kicker: "MILESTONE", name: "Untouchable",
            ...
            ("ms-session90-dialed-in", Milestone(
                id: "session90", kind: .stunt, variantIndex: 0, kicker: "MILESTONE", name: "Dialed In",
            ...
            ("ms-perfect-practice", Milestone(
                id: "perfect", kind: .stunt, variantIndex: 0, kicker: "MILESTONE", name: "Perfect Practice",
            ...
            ("ms-mastery-earned", Milestone(
                id: "mastery-1", kind: .stunt, variantIndex: 0, kicker: "MILESTONE", name: "Mastered: Lib Heel Stretch",
            ...
            ("ms-mastery-teaser-locked", Milestone(
                id: "mastery-teaser", kind: .stunt, variantIndex: 0, kicker: "MILESTONE", name: "Mastery",
                icon: "star.circle.fill", tier: .legendary,
            ...
            ("ms-falls25-gravity-check", Milestone(
                id: "falls25", kind: .stunt, variantIndex: 0, kicker: "DUBIOUS HONOR", name: "Gravity Check",
            ...
            ("ms-coldstreak", Milestone(
                id: "coldstreak", kind: .stunt, variantIndex: 0, kicker: "DUBIOUS HONOR", name: "Cold Streak",
            ...
            ("ms-demolition-day", Milestone(
                id: "demolition", kind: .stunt, variantIndex: 0, kicker: "DUBIOUS HONOR", name: "Demolition Day",
